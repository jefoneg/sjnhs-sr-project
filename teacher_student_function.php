  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="teacher_student_delete.php?id=<?php echo $delrowfetchdata['grades_id']; ?>" class="btn btn-danger">Delete</a>
      </div>
    </div>
  </div>
</div>
<div class="modal fade" id="updatestudent<?php echo $rowfetchdata['grades_id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      ?> 
        <form role="form" action="teacher_student_edit.php?id=<?php echo $erowfetchdata['grades_id']; ?>" method="POST" enctype="multipart/form-data">
              <div class="row">
                    <div class="col-sm-6">
