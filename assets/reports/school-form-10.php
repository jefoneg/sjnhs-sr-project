			...
			<div class='col-sm-12'>
				<table class='heading' border=0>
					<tr>
						...
						<td class='ctr'>Republic of the Philippines</td>
						<td rowspan=4 style='text-align:center;'><img src='icons/deped-icon-1.jpg' class='icon' /></td>
					</tr>
					<tr>
						<td class='ctr'>Department of Education</td>
					</tr>
					<tr>
						<td class='ctr' style='font-size:14px;width:500px;font-weight:bold;'>SENIOR HIGH SCHOOL STUDENT PERMANENT RECORD</td>
					</tr>
				</table>
			</div>
			<div class='col-sm-12'>
