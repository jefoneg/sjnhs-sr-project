		        ...
		        <div class="app-header-content"> 
		            ...
		            <div class="app-utilities col-auto">
			            ...
			            <div class="app-utility-item">
				            <a href="settings_faculty.php" title="Settings">
  ...
  <path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z"/>
			            ...
			            <div class="app-utility-item app-user-dropdown dropdown">
				            ...
				            <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
								<li><a class="dropdown-item" href="settings_faculty.php">Account</a></li>
        ...
        <div id="app-sidepanel" class="app-sidepanel"> 
		  ...
		  <path fill-rule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
						...
						<li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link" href="teacher_dashboard_faculty.php">
						        <span class="nav-icon">
			    ...
			    <div class="app-sidepanel-footer">
				    <nav class="app-nav app-nav-footer">
					    <ul class="app-menu footer-menu list-unstyled">
						    <li class="nav-item">
						        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
						        <a class="nav-link" href="settings_faculty.php">
							        <span class="nav-icon">
				    ...
				    <div class="app-card-header px-4 py-3">
				        <div class="row g-3 align-items-center">
					        ...
					        <div class="col-12 col-lg-auto text-center text-lg-start">
						        <h4 class="notification-title mb-1">Teacher</h4>
								<div class="notification-type mb-2"><span class="badge bg-info">Lists</span></div>
								<button type="button" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#addnewteacher"><i class="fas fa-user-plus"></i>
                                  Add Teacher
                                </button>
					        </div><!--//col-->
				        </div><!--//row-->
						...
						<div class="table-responsive">
							<table id="example" class="table table-sm">
								...
								<tbody>										
									<?php
										include('conn.php');
										$fetchdata = mysqli_query($conn,"select * from user where position = 'Teacher'");
